  ...
  return (
    <div className="flex flex-col justify-bewtween">
      <div className="group mb-8 rounded-xl bg-white px-5 pb-10 pt-12 shadow-testimonial dark:bg-dark dark:shadow-none flex flex-col h-full justify-between">
        <div className="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
          <Image
            ...
            height={120}
          />
          <span className="absolute bottom-0 left-0 -z-10 h-10 w-10 rounded-full opacity-0 transition-all group-hover:opacity-100"                
           style={{
      ...
      <div className="flex flex-col gap-2">
        <Link href={`${tool.link}`} className="text-center bg-blue-700 text-white py-2 rounded-md">
            View Details Page
        </Link>
        <Link href={"google.com"} className="text-center bg-teal-500 text-white py-2 rounded-md">
            Get Now
        </Link>
      </div>
      </div>
